<?php
/*
 arquivo de repetição para a execução da pagina
 de sistema logado caso a session 
        ...
        <div class="d-flex">
            <nav class="sidebar">
                <ul class="list-unstyled">
                    ...
                    <li><a href="../controller/dataUser.php"><i class="fas fa-sign-out-alt"></i>Mostrar usuarios</a></li>
